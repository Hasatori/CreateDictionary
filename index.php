...
if (isset($_POST['start']) && isset($_POST['resultLanguage'])) {
    ...
    foreach ($vocabularies as $key => $vocabulary) {
            ...
            @file_put_contents($path, @file_get_contents("https://dictionary.yandex.net/dicservice.json/lookupMultiple?ui=en&srv=tr-text&sid=b85e299c.5b0c66ee.b4b73bca&text=" . $value . "&dict=en-" . $resultLanguage . ".regular&flags=103", true) . ',' . PHP_EOL, FILE_APPEND);
