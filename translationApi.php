...
?>
        ...
        <div class="container">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="firstValue" name="firstValue" required
    ...
    <div class="container translationResultContainer">
        ...
        <h4 class="text-left">Ostatní překlady </h4>
        <p id="synonyms" class="text-info text-left">
            <?php
            if (isset($result))
                $otherTranslations = $result[2];
            foreach ($otherTranslations as $otherTranslation) {
                $language = getFullLanguageFromAbr($fL);
                echo $otherTranslation[$language . "_value"] . '</br>';
            }
            ?>
        </p>
